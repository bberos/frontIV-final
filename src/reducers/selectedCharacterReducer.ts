...
import { SelectedCharacterActions } from "../actions/selectedCharacterAction";
...
const selectedCharacterReducer: Reducer<
  SelectedCharacterState,
  SelectedCharacterActions
> = (state = initialState, action): SelectedCharacterState => {
  switch (action.type) {
